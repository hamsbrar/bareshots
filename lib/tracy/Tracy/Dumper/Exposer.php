...
final class Exposer
{
	public static function exposeObject(object $obj, Value $value, Describer $describer)
	{
		$tmp = (array) $obj;
	...
	public static function exposeClosure(\Closure $obj, Value $value, Describer $describer)
	{
	...
	public static function exposeArrayObject(\ArrayObject $obj, Value $value, Describer $describer)
	{
		$flags = $obj->getFlags();
	...
	public static function exposeDOMNode(\DOMNode $obj, Value $value, Describer $describer)
	{
	 ...
	 */
	public static function exposeDOMNodeList($obj, Value $value, Describer $describer)
	{
